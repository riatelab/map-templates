...
nuts <- gisco_get_nuts(year = "2021", epsg = "3035", resolution = "20", nuts_level = "2")
bound <- gisco_get_nuts(year = "2021", epsg = "3035", resolution = "20", nuts_level = "0", spatialtype = "BN")
nuts <- st_intersection(nuts, frame)

mf_map(nuts)
mf_map(bound, col = "red", add = TRUE)
